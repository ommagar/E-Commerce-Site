...
<html lang="en">
    ...
    <div id="top-bar" class="container">
					<div class="row">
						<div class="span4">
							<?php echo form_open('admin/search_item'),
							...
							<?php echo form_submit('submit', 'Search',['class'=>'btn btn-info pull-left']),
							      form_close(); ?>
							 <?php echo anchor('admin/filter', 'Filter',['class'=>'btn btn-warning pull-right']); ?>
						</div>
					</div>
				</div>				
						<div class="span8">
	...
	<div id="wrapper" class="container">
			<section class="navbar main-menu">
				<div class="navbar-inner main-menu">				
					<a href="<?php echo base_url('home') ?>" class="logo pull-left"><img src="<?php echo base_url() ?>assets/themes/images/logo.png" class="site_logo" alt=""></a>
							...
							<ul>
								<li><a href="./products.html">Woman</a>					
									...
									<li><a href="./products.html">Man</a>
										...
										<li><a href="./products.html">Jacket</a></li>
									    <li><a href="./products.html">Pants</a></li>
									</ul>
									</li>			
